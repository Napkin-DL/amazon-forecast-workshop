from data.data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom, Dataset_Pred, Dataset_bikeshare
...
#             model = nn.DataParallel(model, device_ids=self.args.device_ids)
    ...
    def _get_data(self, flag):
        ...
        #######################################################
        print(flag, data_set.data_x.shape)
